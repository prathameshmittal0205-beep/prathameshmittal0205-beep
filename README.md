...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:1A1B27,40:3D59A1,70:7AA2F7,100:7DCFFF&height=300&section=header&text=Prathamesh%20Mittal&fontSize=80&animation=fadeIn&fontAlignY=40&desc=AI%20ML%20Enthusiast%20%7C%20Full-Stack%20Engineer&descAlignY=60&descAlign=50&fontColor=FFFFFF&v=5" alt="Header banner" />
</p>
...
I build production-grade applications utilizing the **MERN stack**, design scalable relational and NoSQL databases, and engineer offline AI solutions using **React Native** and **Lightweight CNNs**. Academically, I dive deep into system design, computer architecture, and operating systems. I have also demonstrated my problem-solving ability through **100+ LeetCode problems** and continuous hackathon participation.
...
<details open>
<summary><b>🌐 Full-Stack Web & Mobile</b></summary>
<br />
<div align="center">
...
<details open>
<summary><b>⚙️ Core Systems, Cloud & Analysis</b></summary>
<br />
<div align="center">
...
**🎯 Core Competencies:**
> System Architecture · JWT & RBAC Security · Edge Machine Learning · Explainable AI (SHAP/XGBoost) · Data Clustering (KMeans, BG/NBD) · Full-Stack Database Architecture (Aggregation Pipelines)
...
- Trained an XGBoost classification model to accurately predict credit risk and repayment probability.
- Integrated the SHAP explainability framework to provide transparent, human-readable reasoning for every automated decision.

<br />

### 🎙️ Audium – Cinematic AI Voice Cloning Platform
<p>
